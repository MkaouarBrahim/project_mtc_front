                            ...
                            <div className="card text-black" style={{ borderRadius: 25 }}>
                                <div className="card-body p-md-5">
                                    <div className="row justify-content-center">
                                        ...
                                        <center><h6>Already Member ?   <button type="button" onClick={() => navigate("/SignIn")} className="btn btn-primary">sign In</button></h6></center>
                                            ...
                                            <form className="mx-1 mx-md-4">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input type="date" />
                                                        <label className="form-label" htmlFor="form3Example1c">Date</label>
                                                    </div>
                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                        <i className="fas fa-user fa-lg me-3 fa-fw" />
                                                        <div className="form-outline flex-fill mb-0">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                    <input type="Password" className="form-control" value={Password} placeholder="Passwrd" onChange={(e) => setPassword(e.target.value)} />
                                                ...
                                                <button type="button" className="btn btn-primary py-3 px-5" onClick={handleClick} >Register</button>
                                                </div>
                                            </form>
                                        </div>
